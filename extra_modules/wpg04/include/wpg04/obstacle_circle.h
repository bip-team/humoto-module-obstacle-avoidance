...
namespace humoto
{
    namespace wpg04
    {
         ...
         */
        class HUMOTO_LOCAL ObstacleCircle : public humoto::obstacle_avoidance::ObstacleBase
        {
            public:
                /**
                 * @brief Constructor.
                 ...
                 * @param[in] rpy
                 */
                ObstacleCircle(const etools::Vector3& position,
                                       ...
                                       const double                  safety_margin)
                {
                    ...
                    prev_com_pos  = mpc.position_selector_ * mpc.prev_S_ * previous_solution.get_x() + mpc.position_selector_ * mpc.prev_s_;
